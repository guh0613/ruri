...
@Suite struct RepositoryInstanceCopyTests {
    ...
    func copiesInheritedInstallationAndLocalBytesIntoIndependentVersion(mode: GameRunDirectory) async throws {
        ...
        #expect(manifest.downloads?["client"]?.sha1 == "41035491cd660846382cf22cf26f333f50deebe4")
        ...
        #expect(object.hash == "824b1864c74d74f8aa31e8ea15433739fe517c32" && object.size == 13)
