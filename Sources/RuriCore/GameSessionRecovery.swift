...
public enum GameSessionRecovery {
    public enum Status: Equatable, Sendable {
        case finished, monitoring, monitorUnconfirmed, gameRunning, processEnded, confirmationRequired
    ...
    public static func finish(paths: LauncherPaths, expected: GameSession, userConfirmedEnded: Bool = false) throws -> GameSession {
        ...
        guard record.exit == nil else { throw RuriError.message("记录已经包含游戏退出结果，不能用中断恢复覆盖。") }
