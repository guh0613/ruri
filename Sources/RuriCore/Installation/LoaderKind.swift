...
public enum LoaderKind: String, Codable, CaseIterable, Sendable, Identifiable {
    ...
    public var title: String { switch self { case .vanilla: Messages.CoreLoaderKind.titleText1.localized; case .fabric: "Fabric"; case .quilt: "Quilt"; case .forge: "Forge"; case .neoforge: "NeoForge"; case .legacyfabric: "Legacy Fabric"; case .liteloader: "LiteLoader"; case .optifine: "OptiFine" } }
