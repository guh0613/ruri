...
// Usage: xcrun swift scripts/generate-block-textures.swift <client.jar>
import Foundation
import CoreGraphics
import ImageIO
...
var lines = [
    "// Generated by scripts/generate-block-textures.swift from the Minecraft \(version) client. Do not edit.",
    "",
